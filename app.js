...
function renderBerandaView() {
  ...
  container.innerHTML = `
    <div class="space-y-12 max-w-7xl mx-auto px-1 sm:px-0">
      ...
      <!-- TENTANG INSTITUSI -->
      <div class="relative bg-amber-100/40 rounded-3xl p-6 md:p-8 border border-amber-200/80 shadow-md overflow-hidden">
        ...
        <div class="flex justify-between items-center border-b border-amber-200/60 pb-4 mb-4">
          <h3 class="text-lg md:text-xl font-bold text-slate-800 flex items-center gap-2.5">
            <div class="w-9 h-9 rounded-xl bg-amber-200/60 text-emerald-900 flex items-center justify-center border border-amber-300/60">
              <i data-lucide="building-2" class="w-5 h-5"></i>
            </div>
            Tentang Ma'had Aly
          </h3>
          <button onclick="navigate('/profil')" class="text-xs text-emerald-800 hover:text-emerald-950 font-bold flex items-center gap-1 group">
      ...
      <div class="space-y-5">
        <div class="flex justify-between items-end">
          ...
          <button onclick="navigate('/prodi')" class="text-xs text-emerald-700 hover:text-emerald-900 font-bold flex items-center gap-1 group">
...
/* Modal Admin Authentication & CMS Stubs */
...
function renderAdminDashboard() {
  const titleElem = document.getElementById('admin-table-title');
  if (titleElem) titleElem.innerText = `Data Sheet: ${activeAdminSheet}`;
}